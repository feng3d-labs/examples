namespace feng3d {
    ...
    export class Container3DTest extends Script {
        ...
        init() {
            ...
            this.pointlight = this.gameObject.scene.getComponentsInChildren(PointLight)[0].gameObject;
        }
        ...
        update() {
            ...
            this.pointlight.transform.x = Math.sin(this.num * Math.PI / 180);
            this.pointlight.transform.z = Math.cos(this.num * Math.PI / 180);
        }
