namespace feng3d
{
    ...
    export class AmbientMethod extends RenderDataHolder
    {
        ...
        {
            renderData.addUniform("u_ambient", UniformData.getUniformData(this._color));
            renderData.addUniform("s_ambient", UniformData.getUniformData(this._ambientTexture));
            //
        ...
        {
            renderData.shader.addMacro(Macro.getBoolMacro("HAS_AMBIENT_SAMPLER", this.ambientTexture.checkRenderData()));
        }
    }
}