namespace feng3d
{
    ...
    export class AmbientMethod extends RenderDataHolder
    {
        ...
        {
            renderData.addUniform(RenderData.getUniformData("u_ambient",this._color));
            renderData.addUniform(RenderData.getUniformData("s_ambient",this._ambientTexture));
            //
        ...
        {
            renderData.shader.addMacro(RenderData.getBoolMacro("HAS_AMBIENT_SAMPLER", this.ambientTexture.checkRenderData()));
        }
    }
}