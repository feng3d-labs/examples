namespace feng3d
{
    ...
    export class NormalMethod extends RenderDataHolder
    {
        ...
        {
            renderData.addUniform(UniformData.getUniformData("s_normal",this.normalTexture));
            //
        ...
        {
            renderData.shader.addMacro(Macro.getBoolMacro("HAS_NORMAL_SAMPLER", this.normalTexture.checkRenderData()));
        }
    }
}