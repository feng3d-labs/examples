...
(function (feng3d) {
    ...
    (function (load) {
        var loadJS = (function () {
             ...
             */
            loadJS.prototype.loadjs = function (params) {
             ...
             * @param params.error          错误回调
             */
            loadJS.prototype.ready = function (params) {
             ...
             */
            loadJS.prototype.done = function (bundleId) {
                publish(bundleId, []);
            };
            /**
             * 重置下载包依赖状态
             */
            loadJS.prototype.reset = function () {
                bundleIdCache = {};
                bundleResultCache = {};
                bundleCallbackQueue = {};
            };
             ...
             */
            loadJS.prototype.isDefined = function (bundleId) {
    ...
    })(load = feng3d.load || (feng3d.load = {}));
    feng3d.loadjs = new load.loadJS();
})(feng3d || (feng3d = {}));