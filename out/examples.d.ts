...
declare namespace feng3d {
    class ShaderCode extends EventDispatcher {
        /**
         * 顶点渲染程序代码
         */
        vertexCode: string;
...
declare namespace feng3d {
    ...
    class RenderDataHolder extends EventDispatcher {
        ...
        createAttributeRenderData<K extends keyof AttributeRenderDataStuct>(name: K, data?: Float32Array, stride?: number, divisor?: number): AttributeRenderData;
        createShaderCode(vertexCode: string, fragmentCode: string): ShaderCode;
        ...
        private childrenRenderDataHolder;
        /**
         * 创建GL数据缓冲
         */
        constructor();
         ...
         * 更新渲染数据
         */
        updateRenderShader(renderContext: RenderContext, renderData: RenderAtomic): void;
        protected invalidateRenderData(): void;
        protected invalidateShader(): void;
...
declare namespace feng3d {
    ...
    class Object3DRenderAtomic extends RenderAtomic {
         ...
         */
        static INVALIDATE_SHADER: string;
        private _invalidateRenderDataHolderList;
        private _invalidateShaderList;
...
declare namespace feng3d {
    ...
    class AttributeRenderData {
         ...
         */
        private _invalid;
        constructor(name: string, data?: Float32Array, stride?: number, divisor?: number);
        /**
         * 使数据缓冲失效
         */
        invalidate(): void;
...
declare namespace feng3d {
    ...
    class RenderContext extends RenderDataHolder {
         ...
         * 更新渲染数据
         */
        updateRenderData1(renderAtomic: RenderAtomic): void;
    }
}
declare namespace feng3d {
    /**
...
declare namespace feng3d {
    ...
    class GameObject extends Feng3dObject {
        static readonly gameObjects: GameObject[];
         ...
         * @param param 被添加组件
         */
        addComponent<T extends Component>(param: T | (new () => T)): T;
        /**
         * 判断是否拥有组件
         * @param com	被检测的组件
...
declare namespace feng3d {
    ...
    class Geometry extends Component {
         ...
         * @param stride        顶点数据步长
         */
        setVAData<K extends keyof AttributeRenderDataStuct>(vaId: K, data: Float32Array, stride: number): void;
        /**
         * 获取顶点属性数据
         * @param vaId 数据类型编号
         * @return 顶点属性数据
...
declare namespace feng3d {
    ...
    class ParticleComponent extends RenderDataHolder {
        ...
        setRenderState(particleGlobal: ParticleGlobal, gameObject: GameObject, renderContext: RenderContext): void;
    }
}
declare namespace feng3d {
    /**
