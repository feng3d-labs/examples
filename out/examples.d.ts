...
declare namespace feng3d {
    ...
    interface IAddMacros {
         ...
         * 是否需要变量全局坐标
         */
        V_GLOBAL_POSITION_NEED: AddMacro;
        /**
         * 是否需要属性法线
         */
        A_NORMAL_NEED: AddMacro;
        /**
         * 是否需要变量法线
         */
        V_NORMAL_NEED: AddMacro;
        /**
         * 是否需要摄像机矩阵
         */
        U_CAMERAMATRIX_NEED: AddMacro;
    }
}
declare namespace feng3d {
    /**
...
declare namespace feng3d {
    class ComponentMap {
        ...
        static readonly instance: ComponentMap;
...
declare namespace feng3d {
    ...
    class GameObject extends Feng3dObject {
         ...
         * @param param 被添加组件
         */
        addComponent<T extends Component, K extends keyof ComponentMap>(param: T | (new () => T) | K): T;
        /**
         * 判断是否拥有组件
         * @param com	被检测的组件
