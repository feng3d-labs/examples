...
(function (feng3d) {
    ...
    initObjects();
    initLights();
    feng3d.ticker.on("enterFrame", setPointLightPosition);
    ...
    //
    feng3d.input.on("keyup", function (event) {
    ...
    function initLights() {
        ...
        light0.addComponent(feng3d.MeshFilter).mesh = new feng3d.SphereGeometry(5);
        //初始化点光源
