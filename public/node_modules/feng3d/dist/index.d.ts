...
declare class ReadRS {
     ...
     */
    createAsset<T extends FileAsset>(Cls: new () => T, fileName?: string, value?: gPartial$1<T>, parent?: FolderAsset, callback?: (err: Error, asset: T) => void): void;
    /**
     * 获取有效子文件名称
     *
     * @param parent 父文件夹
