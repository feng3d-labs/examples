...
class Basic_Fire extends feng3d.Script
{
    /**
     * 初始化时调用
     */
    init()
    {
        ...
        var NUM_FIRES = 10;
        var cameraController: feng3d.HoverController;
        var planeMaterial: feng3d.StandardMaterial;
        var particleMaterial: feng3d.StandardMaterial;
        var directionalLight: feng3d.DirectionalLight;
        var particleGeometry: feng3d.PlaneGeometry;
        var timer: feng3d.Timer;
        ...
        function onTimer()
        {
            ...
            var light: feng3d.PointLight = lightObject.addComponent(feng3d.PointLight);
        ...
        function onEnterFrame()
        {
            ...
            for (fireVO_key_a in fireObjects)
            {
                ...
                var light: feng3d.PointLight = fireVO.light;
                if (<any>!light)
                    continue;
