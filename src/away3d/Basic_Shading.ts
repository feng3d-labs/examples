import { Camera, Color4, CubeGeometry, DirectionalLight, FPSController, Geometry, Material, MeshRenderer, Node3D, PlaneGeometry, Scene, serialization, SphereGeometry, StandardMaterial, ticker, TorusGeometry, Vector3, View } from 'feng3d';
