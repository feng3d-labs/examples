import { Camera, Color3, Color4, CubeGeometry, FogMode, MeshRenderer, Node3D, Scene, Script, Serializable, $set, StandardMaterial, StandardUniforms, Texture2D, Vector3, View3D } from 'feng3d';
