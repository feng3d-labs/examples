module feng3d {
    export class ParticleAnimatorTest {
        ...
        init() {
            ...
            particle.getOrCreateComponentByClass(MeshFilter).geometry = new PointGeometry();
            particle.getOrCreateComponentByClass(MeshRenderer).material = new ParticleMaterial();
